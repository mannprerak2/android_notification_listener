...
```yamloutput: 'generated_bindings.dart'```</td>
  </tr>
  <tr>
...
```yamldescription: 'Bindings to SQLite'```</td>
  </tr>
  <tr>
    <td>compiler-opts</td>
...
```yamlcompiler-opts: '-I/usr/lib/llvm-9/include/'```</td>
  </tr>
  <tr>
...
```yamluse-supported-typedefs: true```</td>
  </tr>
  <tr>
    <td>dart-bool</td>
...
preamble: |
  ...
  ///
  /// Generated by `package:ffigen`.```</td>
  </tr>
  <tr>
    <td>size-map</td>
